...
\documentclass[a4paper,12pt]{hogent-article}
...
\PaperTitle{Het verschil tussen Westerse en Chinese IOT devices met privacy en beveiliging en het gebruik van de data}
...
\Authors{Mike Decorte\textsuperscript{1}} % Authors
